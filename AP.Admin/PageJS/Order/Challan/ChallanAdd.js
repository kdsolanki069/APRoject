...
$('#btnAddChallan').click(function () {
    ...
    if (status) {
        var UserObject =  GetChallanValue();
        InsertUpdateChallan(UserObject);
    }
    else {
...
function InsertUpdateChallan(UserObject) {   
    ...
    function OnSuccess(data) {
        if (data != -1) {
            if (data.Status == "True") {
                ...
                $('#txttext').text('Challan Detail Add Sucessfully');
